...
class Movie {
  ...
  @override
  String toString() => 'Movie(title: $title, overview: $overview, voteAverage: $voteAverage'
      ', genres: $genres, releaseDate: $releaseDate, backdropPath: $backdropPath, posterPath: $posterPath';
