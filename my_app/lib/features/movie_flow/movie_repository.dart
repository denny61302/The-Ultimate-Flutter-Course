...
abstract class MovieRepository {
  ...
  Future<List<MovieEntity>> getRecommendedMovie(double rating, String date, String genreIds);
}
...
class TMDBMovieRepository implements MovieRepository {
  ...
  @override
  Future<List<MovieEntity>> getRecommendedMovie(double rating, String date, String genreIds) async {
    try {
      final response = await dio.get(
        'discover/movie',
        queryParameters: {
